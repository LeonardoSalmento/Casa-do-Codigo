...
namespace CasaDoCodigo.Repositories
{
    ...
    public class PedidoRepository : BaseRepository<Pedido>, IPedidoRepository
    {
        ...
        public PedidoRepository(ApplicationContext contexto, IItemPedidoRepository itemPedidoRepository, IHttpContextAccessor contextAccessor) : base(contexto)
        {
        ...
        public void AddItem(string codigo)
        {
            ...
            if (produto == null)
            {
                throw new ArgumentException("Produto não encontro");
            }
